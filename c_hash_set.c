...
// В случае успешной вставки возвращает > 0, и хэш-множество захватывает данные.
// Если такие данные уже есть,то функция возвращает 0, а хэш-множество не звахватывает данные.
