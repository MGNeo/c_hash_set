...
// В случае успешной вставки возвращает > 0, данные захватываются хэш-множеством.
// Если такие данные уже есть, то функция возвращает 0, данные не захватываются хэш-множеством.
// В случае ошибки возвращает < 0, данные не захватываются хэш-множеством.
